...
```{r, echo=FALSE, include=FALSE, SGP_Object_Tests}
  ##  Load any R packages and functions required to render or 'knit' report.  
	...
	##  Identify whether or not there are EOCT courses in the data
	eoct.tf <- any(grepl("EOCT", Demonstration_SGP@Data[YEAR=='2016_2017']$GRADE))
	if (eoct.tf) {
		GL_subjects <- unique(Demonstration_SGP@Data[YEAR=='2016_2017' & GRADE != "EOCT", CONTENT_AREA])
		EOCT_subjects <- unique(Demonstration_SGP@Data[YEAR=='2016_2017' & GRADE == "EOCT", CONTENT_AREA])
	} else GL_subjects <- unique(Demonstration_SGP@Data[YEAR=='2016_2017', CONTENT_AREA])
```
#  Introduction
...
```{r, cache=TRUE, echo=FALSE, include=FALSE}
	n_tbl <- table(Demonstration_SGP@Data[YEAR=='2016_2017' & VALID_CASE=='VALID_CASE']$CONTENT_AREA, Demonstration_SGP@Data[YEAR=='2016_2017' & VALID_CASE=='VALID_CASE']$GRADE)
```
