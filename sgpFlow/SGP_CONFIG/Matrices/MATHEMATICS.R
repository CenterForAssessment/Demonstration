################################################################################
###                                                                          ###
###      MATHEMATICS matrix configurations                                   ###
###                                                                          ###
################################################################################

MATHEMATICS_Matrix.config <- list(
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 2),
		sgp.baseline.panel.years=c("2023_2024", "2024_2025"),
	...
	list(
		...
		sgp.baseline.panel.years=c("2022_2023", "2023_2024", "2024_2025"),
