MATHEMATICS_BASELINE.config <- list(
	...
	list(
		...
		sgp.baseline.panel.years=c("2015_2016", "2016_2017", "2017_2018", "2018_2019", "2019_2020"),
		sgp.baseline.grade.sequences=c("3", "4", "5", "6"),
	...
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 4),
		sgp.baseline.panel.years=c("2015_2016", "2016_2017", "2017_2018", "2018_2019", "2019_2020"),
		sgp.baseline.grade.sequences=c("4", "5", "6", "7"),
		sgp.baseline.grade.sequences.lags=c(1,1,1)),
	###  SKIP YEAR
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 2),
	...
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 4),
		sgp.baseline.panel.years=c("2015_2016", "2016_2017", "2017_2018", "2018_2019", "2019_2020"),
		sgp.baseline.grade.sequences=c("5", "6", "7", "8"),
		sgp.baseline.grade.sequences.lags=c(1,1,1)),
	###  SKIP YEAR
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 2),
	...
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 4),
		sgp.baseline.panel.years=c("2015_2016", "2016_2017", "2017_2018", "2018_2019", "2019_2020"),
		sgp.baseline.grade.sequences=c("6", "7", "8", "9"),
		sgp.baseline.grade.sequences.lags=c(1,1,1)),
	###  SKIP YEAR
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 2),
	...
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 4),
		sgp.baseline.panel.years=c("2015_2016", "2016_2017", "2017_2018", "2018_2019", "2019_2020"),
		sgp.baseline.grade.sequences=c("7", "8", "9", "10"),
		sgp.baseline.grade.sequences.lags=c(1,1,1)),
	###  SKIP YEAR
	list(
		sgp.baseline.content.areas=rep("MATHEMATICS", 2),
